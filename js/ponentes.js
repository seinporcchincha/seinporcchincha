...
jQuery(function ($) {
  ...
  const PONENTES = [
    ...
    { id: 2, nombre: "Ing. Rogelio Sobero Ballardo", especialidad: "Docente e investigador - Universidad Nacional Cristóbal de Huamanga", bio: "El Ing. Rogelio Sobero Ballardo, Ingeniero Zootecnista colegiado CIP N.º 74605, es docente de la Universidad Nacional de San Cristóbal de Huamanga y exdocente de las universidades Hermilio Valdizán de Huánuco y Daniel Alcides Carrión de Pasco–Oxapampa; cuenta con estudios de Maestría en Gestión Ambiental en Ganadería y Doctorado en Gestión Ambiental y Desarrollo Sostenible, además de amplia experiencia profesional en la producción pecuaria en las regiones de costa, sierra y selva del Perú, con enfoque en sostenibilidad, desarrollo rural y aprovechamiento responsable de los recursos agropecuarios.", foto: "assets/img/soberoballardo.jpg" },
